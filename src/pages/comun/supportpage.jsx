    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="container mx-auto py-12 px-4 max-w-6xl">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-blue-800 mb-3">Contactez notre équipe</h1>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-blue-100">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold text-blue-800">Chat en direct</h3>
                  <p className="text-black">Disponible sur votre espace</p>
                  <p className="text-sm text-blue-500 mt-1">Connectez-vous pour accéder au chat</p>
                </div>
              </div>
            </div>
            ...
            {submitted ? (
              <div className="text-center py-8">
                <div className="inline-flex items-center justify-center w-20 h-20 bg-blue-100 rounded-full mb-4">
                  <FaPaperPlane className="text-black text-3xl" />
                </div>
                <h3 className="text-2xl font-bold text-blue-800 mb-2">Message envoyé !</h3>
                <p className="text-black">Notre équipe vous répondra dans les plus brefs délais.</p>
              </div>
            ) : (
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    <label htmlFor="name" className="block text-sm font-medium text-blue-800 mb-1">Nom complet</label>
                    <input
                      type="text"
                      id="name"
                      name="name"
                  ...
                  <div>
                    <label htmlFor="email" className="block text-sm font-medium text-blue-800 mb-1">Adresse email</label>
                    <input
                      type="email"
                      id="email"
                      name="email"
                  ...
                  <div>
                    <label htmlFor="subject" className="block text-sm font-medium text-blue-800 mb-1">Sujet</label>
                    <select
                      id="subject"
                      name="subject"
                  ...
                  <div>
                    <label htmlFor="message" className="block text-sm font-medium text-blue-800 mb-1">Votre message</label>
                    <textarea
                      id="message"
                      name="message"
