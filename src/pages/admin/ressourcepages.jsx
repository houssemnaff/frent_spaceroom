...
import { FileText, Search, Plus, Download, File, Image, Video, MoreVertical, Calendar, Play, ExternalLink, X, BookOpen, Users, BarChart2 } from "lucide-react";
        ...
        <DialogContent className="sm:max-w-[800px]">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button onClick={() => handleViewResource(selectedResource)}>
                {selectedResource?.type === "video" ? "Regarder" : "Télécharger"}
              </Button>
            </div>
          </div>
        </DialogContent>
