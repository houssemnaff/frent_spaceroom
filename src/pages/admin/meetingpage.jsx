...
const MeetingPage = () => {
  ...
  // Fonction pour rediriger vers la page de modification d'une réunion
  const handleEditMeeting = (meetingId) => {
    // Vous pouvez rediriger vers une page de modification ou ouvrir un modal
    console.log(`Modifier la réunion ${meetingId}`);
    // Si vous utilisez react-router-dom, vous pourriez faire:
                ...
                <div className="flex items-center gap-2">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem onClick={() => handleEditMeeting(meeting._id)}>
