...
const StudentList = () => {
  ...
  const handleRemoveStudent = (student) => {
    if (!isOwner) {
      alert("Vous devez être le propriétaire du cours pour supprimer un étudiant.");
      return;
    }
    ...
    return (
      <div className="mt-2 space-y-2">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs font-medium">{progress.progressPercentage}%</span>
        </div>
        ...
        <div className="grid grid-cols-3 gap-2 text-xs">
          ...
          <div className="flex items-center gap-1">
            ...
            <span>{progress.completedQuizzes}/{progress.totalQuizzes} chapitres</span>
          </div>
        </div>
      </div>
    );
